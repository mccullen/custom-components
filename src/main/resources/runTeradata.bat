...
java -cp "%CLASS_PATH%" %LOG4J_PARM% -Djavax.security.auth.useSubjectCredsOnly=false -Djava.security.auth.login.config=C:\ProgramData\Teradata\jaas.conf -Djava.security.krb5.conf=C:\ProgramData\Teradata\krb5.conf -Xms512M -Xmx3g %PIPE_RUNNER% %*
cd %CURRENT_DIR%
